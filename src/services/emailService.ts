...
class EmailService {
   ...
   * A short congratulations note — challenge is now a draft; open registration from Settings.
   */
  async sendChallengeApproved(to: string, data: {
    ...
    try {
      ...
      const content = `
        <h2 style="color: #16a34a; font-size: 20px; margin: 0 0 8px; font-weight: 700;">&#127881; Congratulations — Your Challenge is Approved!</h2>
        <p style="color: #374151; font-size: 15px; line-height: 1.6; margin: 0 0 20px;">
          Hi <strong>${data.displayName}</strong>, good news — your challenge has been reviewed and approved.
        </p>

        <div style="background: #f0fdf4; border-radius: 10px; padding: 16px 20px; border: 1px solid #bbf7d0; margin-bottom: 20px;">
          <p style="color: #166534; font-size: 16px; font-weight: 700; margin: 0 0 4px;">${data.challengeTitle}</p>
          <p style="color: #16a34a; font-size: 13px; margin: 0; font-weight: 600;">Status: Draft</p>
        </div>

        <p style="color: #374151; font-size: 14px; line-height: 1.7; margin: 0 0 20px;">
          Your challenge is now saved as a <strong>draft</strong>. When you're ready to start accepting participants, go to the
          <strong>Settings</strong> tab in your dashboard and <strong>open registration</strong>.
        </p>
