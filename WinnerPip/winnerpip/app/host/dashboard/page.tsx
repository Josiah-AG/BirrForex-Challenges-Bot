                  ...
                  {createForm.type === 'hybrid' && createForm.split_category_settings ? (
                    <>
                      <div className="p-3 rounded-lg bg-blue-500/5 border border-blue-500/10 mb-2">
                        ...
                        {createRulesDemo.rules_enabled.max_lot_size && <div className="flex justify-between py-1"><span className="text-gray-500">Max Lot</span><span className="text-white">{createRulesDemo.max_lot_size}</span></div>}
                        ...
                        {createRulesDemo.rules_enabled.daily_loss_cap && <div className="flex justify-between py-1"><span className="text-gray-500">Daily Loss</span><span className="text-white">{createRulesDemo.daily_loss_mode === 'percentage' ? `${createRulesDemo.daily_loss_percent}%` : `$${createRulesDemo.daily_loss_cap}`}</span></div>}
                        {createRulesDemo.rules_enabled.min_active_days && <div className="flex justify-between py-1"><span className="text-gray-500">Min Days</span><span className="text-white">{createRulesDemo.min_active_days}</span></div>}
                        {createRulesDemo.rules_enabled.min_total_trades && <div className="flex justify-between py-1"><span className="text-gray-500">Min Trades</span><span className="text-white">{createRulesDemo.min_total_trades}</span></div>}
                      </div>
                      <div className="p-3 rounded-lg bg-profit/5 border border-profit/10">
                        ...
                        {createRulesReal.rules_enabled.max_lot_size && <div className="flex justify-between py-1"><span className="text-gray-500">Max Lot</span><span className="text-white">{createRulesReal.max_lot_size}</span></div>}
                        ...
                        {createRulesReal.rules_enabled.daily_loss_cap && <div className="flex justify-between py-1"><span className="text-gray-500">Daily Loss</span><span className="text-white">{createRulesReal.daily_loss_mode === 'percentage' ? `${createRulesReal.daily_loss_percent}%` : `$${createRulesReal.daily_loss_cap}`}</span></div>}
                        {createRulesReal.rules_enabled.min_active_days && <div className="flex justify-between py-1"><span className="text-gray-500">Min Days</span><span className="text-white">{createRulesReal.min_active_days}</span></div>}
                        {createRulesReal.rules_enabled.min_total_trades && <div className="flex justify-between py-1"><span className="text-gray-500">Min Trades</span><span className="text-white">{createRulesReal.min_total_trades}</span></div>}
